...
public class HabitHome_Adapter extends RecyclerView.Adapter<HabitHome_Adapter.ViewHolder>  {
    ...
    public HabitHome_Adapter(Context context, List<Habit> mData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_habithome,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull  HabitHome_Adapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if (habit.habitStart==0){
                ...
                textViewok.setOnClickListener(v1 -> {
                    ...
                    alarmReceiver.setRepeatingAlarm(context, AlarmReceiver.TYPE_REPEATING,habit.habitTime, habit.habitTitle, habit.habitid+"");
